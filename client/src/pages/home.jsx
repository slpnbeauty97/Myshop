    ...
    <div className="bg-[#121212] text-white min-h-screen font-sans">
      ...
      <header className="flex items-center justify-between px-8 py-5 border-b border-gray-800">
        <nav className="space-x-8 text-sm font-medium text-white">
          <a href="https://christo4ryoung.store/" className="hover:text-gray-400 no-underline">Home</a>
          <a href="https://soundcloud.com/slpnbeauty/sets/cybers3x2k" className="hover:text-gray-400 no-underline">Catalog</a>
          <a href="https://www.instagram.com/slpn.beauty" className="hover:text-gray-400 no-underline">Contact</a>
        </nav>
        <div className="space-x-5 text-xl relative">
          <i className="ri-search-line" aria-label="Search"></i>
          <i className="ri-user-line" aria-label="User"></i>
        </div>
      </header>
      ...
      <section className="relative h-[80vh] bg-black">
        ...
        <div className="relative z-10 flex h-full w-full items-center justify-between px-10 max-w-7xl mx-auto">
          ...
          <p className="text-right max-w-sm text-gray-300 text-lg">
            From Chrx! latest album Cyber$3x2k! Cop some Merch!! and Gifts for your Digital Loved Ones!!
          </p>
        </div>
      </section>
            ...
            <div key={product.id} className="bg-white text-black p-3 rounded-lg shadow-sm relative">
              ...
              {visibleInstructionId === product.id && (
                <div className="mt-4 p-4 bg-black text-white text-sm rounded-lg border border-green-700 space-y-2">
                  ...
                  <p>6. Send confirmation to <strong>0752714914</strong> (WhatsApp)</p>
                </div>
              )}
            </div>
          ))}
